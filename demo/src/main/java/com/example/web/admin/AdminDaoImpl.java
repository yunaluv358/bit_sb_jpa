...
public class AdminDaoImpl implements AdminDao{
    ...
    public void insert(Admin admin) {
        System.out.println("3. AdminDaoImpl insert :::::"+Data.ADMIN_PATH.toString() + Data.LIST.toString() + Data.CSV);
        try {
            BufferedWriter writer = new BufferedWriter(
                                    new FileWriter(
                                    new File(Data.ADMIN_PATH.toString() + Data.LIST.toString() + Data.CSV), true));
